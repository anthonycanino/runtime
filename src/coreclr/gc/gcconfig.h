...
#define GC_CONFIGURATION_KEYS \
    ...
    BOOL_CONFIG  (TouchClear,                "gcTouchClear",              NULL,                                false,              "Whether we should touch all pages for DML")                                              \
    BOOL_CONFIG  (UseDevicePF,               "gcUseDevicePF",             NULL,                                false,              "Whether we let DSA handle page faults")                                                  \
    BOOL_CONFIG  (DMLSmall,                  "gcDMLSmall",                NULL,                                false,              "Whether we should send small objects to DSA")                                            \
