...
REGDEF(KMASK0,    0+KMASKBASE,  KMASKMASK(0),   "0"  )
REGDEF(KMASK1,    1+KMASKBASE,  KMASKMASK(1),   "1"  )
REGDEF(KMASK2,    2+KMASKBASE,  KMASKMASK(2),   "2"  )
REGDEF(KMASK3,    3+KMASKBASE,  KMASKMASK(3),   "3"  )
REGDEF(KMASK4,    4+KMASKBASE,  KMASKMASK(4),   "4"  )
REGDEF(KMASK5,    5+KMASKBASE,  KMASKMASK(5),   "5"  )
REGDEF(KMASK6,    6+KMASKBASE,  KMASKMASK(6),   "6"  )
REGDEF(KMASK7,    7+KMASKBASE,  KMASKMASK(7),   "7"  )
