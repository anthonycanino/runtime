...
#define KMASKBASE 32
#define KMASKMASK(x) (__int64(1) << ((x)+KMASKBASE))
...
REGDEF(KMASK0,    0+KMASKBASE,  KMASKMASK(0),   "k0"  )
REGDEF(KMASK1,    1+KMASKBASE,  KMASKMASK(1),   "k1"  )
REGDEF(KMASK2,    2+KMASKBASE,  KMASKMASK(2),   "k2"  )
REGDEF(KMASK3,    3+KMASKBASE,  KMASKMASK(3),   "k3"  )
REGDEF(KMASK4,    4+KMASKBASE,  KMASKMASK(4),   "k4"  )
REGDEF(KMASK5,    5+KMASKBASE,  KMASKMASK(5),   "k5"  )
REGDEF(KMASK6,    6+KMASKBASE,  KMASKMASK(6),   "k6"  )
REGDEF(KMASK7,    7+KMASKBASE,  KMASKMASK(7),   "k7"  )

REGDEF(STK,       8+KMASKBASE,  0x0000,         "STK" )
#endif // !TARGET_X86
